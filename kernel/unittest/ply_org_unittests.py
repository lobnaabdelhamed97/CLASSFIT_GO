...
class TestPendPlayer(unittest.TestCase):
    ...
    def test_ply_org(self):
        try:
            ...
            i = 1
            expected_output = {
                "organizer id required", "player id required", "contact id required",
                "{'fname': 'c', 'lname': 'm%20', 'email': 'amtesting94', 'gender': None, 'plyAge': None, 'plyImg': '', 'phone': '0999', 'type': 'contact'}"
            }
            result_response = []
